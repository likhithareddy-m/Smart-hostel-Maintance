 ...
 * My Complaints / Status Tracking, Report a Problem, and Admin Login.
 */
function App() {
  // Current active view state: 'role-selection' | 'student-login' | 'student-dashboard' | 'my-complaints' | 'report-problem' | 'admin-login'
  ...
  return (
    <div className="app-root">
      ...
      {currentView === 'admin-login' && (
        <AdminLogin onBack={handleBackToRoleSelection} />
      )}
    </div>
  );
}
