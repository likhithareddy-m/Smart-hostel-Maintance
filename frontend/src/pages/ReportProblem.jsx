...
import { addComplaint } from '../services/complaintStorage.js';
 ...
 * 
 * @param {Object} props
 * @param {Object} props.student - Logged-in student details
 * @param {Function} props.onBack - Callback to return to student dashboard
 * @param {Function} props.onComplaintSubmitted - Callback after successful submission
 */
    ...
    if (validate()) {
      ...
      setTimeout(() => {
        ...
        if (onComplaintSubmitted) {
          setTimeout(() => {
            onComplaintSubmitted(newRecord);
          }, 4000);
        }
      }, 800);
    }
